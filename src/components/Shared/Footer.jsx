const Footer = () => {
  return (
    <footer className="footer p-10 bg-[url('https://yokaz.myshopify.com/cdn/shop/files/footerbg.png?v=1619691995')] text-neutral-content bg-center bg-no-repeat bg-cover">
      <div>
      ...
      <div>
        ...
        <div className="grid grid-flow-col gap-4">
          <a className=" rounded-full border p-2 bg-blue-400">
            <svg
          ...
          <a className=" rounded-full border p-2 bg-red-600">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a className=" rounded-full border p-2 bg-blue-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
