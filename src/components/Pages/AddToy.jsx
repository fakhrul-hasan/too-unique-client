...
const AddToy = () => {
    ...
    const handleAddToy=event=>{
        ...
        const toy = {picture: picture, name: name, sellerName: sellerName, sellerEmail: sellerEmail, subCategoryName: subCategoryName, price: price, rating: rating, qty: qty, detail: detail}
        console.log(toy);
  ...
  return (
    <div className="px-10 mb-8">
      ...
      <form onSubmit={handleAddToy} className="flex flex-col justify-center gap-4">
        ...
        <div className="flex justify-center w-full gap-2">
          <div className="w-1/2">
            ...
            <TextInput name="sellerName" type="text"  defaultValue={user.displayName} required={true} />
          </div>
          <div className="w-1/2">
            <div className="mb-2 block">
              <Label htmlFor="sellerEmail" value="Seller Email" />
            </div>
            <TextInput name="sellerEmail" type="email" defaultValue={user.email}/>
          </div>
        </div>
        <div className="flex justify-center w-full gap-2">
          <div className="w-1/2">
            <div className="mb-2 block">
              <Label htmlFor="subCategoryName" value="Sub-category Name" />
            </div>
            <TextInput name="subCategoryName" type="text" required={true} />
          </div>
          <div className="w-1/2">
            <div className="mb-2 block">
        ...
        <div className="mb-2 block">
            ...
            <TextInput name="detail" type="text" required={true} />
